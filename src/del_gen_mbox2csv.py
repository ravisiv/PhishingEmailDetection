...
def get_email_as_dict(msg):
    ...
    all_urls_vectors = []
    all_header_vectors = []
    all_topdomain_vectors = []
    all_subdomain_vectors = []
    all_suffix_vectors = []
...
master_urls = conf_dir + "masterdata/urlsinmails.csv"
master_headers = conf_dir + "masterdata/headersinmails.csv"
master_topdomains = conf_dir + "masterdata/topdomainsinmails.csv"
master_subdomains = conf_dir + "masterdata/subdomainsinmails.csv"
master_suffix = conf_dir + "masterdata/suffixinmails.csv"
    ...
    with open(f"{data_path}/{file}") as f:
        ...
        if not ".msgtype" in f.name:
            try:
                ...
                all_email_data.append(metadata)
                print(idx, end=" ")
            except Exception as e:
                print("--------------------------------starting------------")
...
emaildata_file = f"{datadir}/allemails.csv"
